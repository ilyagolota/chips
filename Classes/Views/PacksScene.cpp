...
#include "Extensions/TransitionAnimation.h"
...
void PacksScene::_build()
{
	...
	for (auto pack : _game->getLevelPacks())
	{
        ...
        button->addTouchEventListener([this, pack](cocos2d::Ref* sender, cocos2d::ui::Widget::TouchEventType type)
        {
            ...
            {
                auto scene = LevelListScene::create(_game, 0, 0);
                cocos2d::Director::getInstance()->pushScene(TransitionAnimation::create(0.5f, scene));
            }
        });
        x += buttonWidth;

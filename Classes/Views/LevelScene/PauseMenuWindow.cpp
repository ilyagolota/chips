...
PauseMenuWindow::PauseMenuWindow(LevelScene* levelScene)
{
    ...
    auto resumeButton = cocos2d::ui::Button::create("ball-stay-east.png", "", "", cocos2d::ui::Widget::TextureResType::PLIST);
    ...
    resumeButtonLabel->enableOutline(cocos2d::Color4B::BLACK, 2);
    resumeButton->addChild(resumeButtonLabel);
    
    auto restartButton = cocos2d::ui::Button::create("ball-stay-east.png", "", "", cocos2d::ui::Widget::TextureResType::PLIST);
    ...
    restartButtonLabel->enableOutline(cocos2d::Color4B::BLACK, 2);
